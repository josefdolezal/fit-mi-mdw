...
public class BookingsProcessor implements MessageListener {
	// connection factory
    ...
    public void onMessage(Message msg) {
        try {
            ...
            if (msg instanceof TextMessage) {
                ...
                if(text.equals("book trip")) {
                	msgText = "BookingsProcessor: trip booked";
                } else {
                	msgText = "BookingsProcessor: unexpected message content:" + text;
                }
            } else {
                msgText = "BookingsProcessor: unexpected message content:" + msg.toString();
            }
    ...
    public void receive(String queueName) throws Exception {
        ...
        System.out.println("BookingsProcessor: Receiving messages");
        try {
            synchronized (this) {
                while (true) {
                    this.wait();
    ...
    public static void main(String[] args) throws Exception {
        // input arguments
        String queueName = "jms/mdw-6-booking-queue";
 
        // create the producer object and receive the message
        BookingsProcessor processor = new BookingsProcessor();
